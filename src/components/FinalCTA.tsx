...
const FinalCTA = () => {
  return (
    <section id="contact" className="relative py-32 overflow-hidden">
      ...
      {/* Animated Glow Orbs */}
      <motion.div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gold-500/10 blur-3xl"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.4, 0.2],
        }}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gold-500/30 bg-gold-500/10 mb-8">
            ...
            <span className="text-gold-400 text-sm font-medium">Limited Spots Available</span>
          </div>
