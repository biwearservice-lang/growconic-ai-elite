          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center hover:bg-gold-500/20 hover:border-gold-500/30 border border-transparent transition-all"
              >
                <Linkedin className="w-5 h-5 text-muted-foreground hover:text-gold-400" />
              </a>
              <a
                href="mailto:hello@growconic.com"
                className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center hover:bg-gold-500/20 hover:border-gold-500/30 border border-transparent transition-all"
              >
                <Mail className="w-5 h-5 text-muted-foreground hover:text-gold-400" />
              </a>
            </div>
          </div>
